...
return [
    ...
    'ascii' => 'يجب أن يحتوي :attribute على أحرف أبجدية رقمية وأحرف رمزية أحادية البايت فقط.',
    ...
    'decimal' => 'يجب أن يحتوي :attribute على :decimal من الأماكن العشرية.',
    ...
    'doesnt_end_with' => 'لا يمكن أن ينتهي :attribute بأحد ما يلي: :values.',
    'doesnt_start_with' => 'لا يمكن أن يبدأ :attribute بأحد ما يلي: :values.',
    ...
    'hex_color' => 'يجب أن يكون :attribute لونًا سداسي عشريًا صالحًا.',
    ...
    'lte' => [
        'array' => 'لا يمكن أن يحتوي :attribute على أكثر من :value عنصرًا.',
    ...
    'max' => [
        ...
        'string' => 'لا يمكن أن يحتوي :attribute على أكثر من :max حرفًا.',
    ],
    'max_digits' => 'لا يمكن أن يحتوي :attribute على أكثر من :max رقمًا.',
    ...
    'attributes' => [
        ...
        'lecturer_number' => 'رقم المحاضر',
        'student_number' => 'رقم الطالب',
        'study_program_id' => 'برنامج الدراسة',
        'faculty_id' => 'الكلية',
        'course_id' => 'المادة',
