<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="card-saas dark:bg-gray-800 p-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <p class="text-sm text-primary-secondary dark:text-gray-400">
                            {{ __('From:') }} <span class="font-medium text-primary-dark dark:text-gray-300">{{ $report->user->name }}</span> ({{ $report->user->student->student_number ?? '-' }})
                        </p>
            ...
            <div class="prose dark:prose-invert max-w-none text-primary-dark dark:text-gray-300 whitespace-pre-wrap mb-6">{{ $report->message }}</div>
        ...
        <div class="card-saas dark:bg-gray-800 p-6">
            <h3 class="font-bold text-primary-dark dark:text-white mb-4">{{ $report->admin_reply ? __('Previous Reply') : __('Leave a Reply') }}</h3>
            ...
            <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 mb-6">
                ...
                <p class="text-xs text-primary-secondary dark:text-gray-500 mt-4">
        ...
        <div class="flex justify-start">
            <a href="{{ route('admin.report.index') }}" class="flex items-center gap-2 text-sm text-primary-secondary dark:text-gray-400 hover:text-primary-primary transition">
