    ...
    <div class="min-h-screen flex">
        ...
        <aside
            ...
            <div class="h-20 flex items-center justify-between px-5 logo-section">
                <div class="flex items-center gap-3 overflow-hidden">
                    ...
                    <div class="sidebar-logo-text">
                        <h1
                            class="text-lg font-bold bg-gradient-to-r from-primary-primary to-primary-dark bg-clip-text text-transparent">
                            {{ config('app.name') }}
                        </h1>
                        <p class="text-[10px] font-medium tracking-wider uppercase"
                            style="color: var(--text-secondary);">{{ __('Academic Management') }}
                        </p>
                    </div>
                </div>
                <!-- Desktop Toggle -->
            ...
            <nav class="px-3 py-6 space-y-1.5 overflow-y-auto" style="max-height: calc(100vh - 200px);">
                ...
                @if(Auth::user()->isAdmin())
                    ...
                    <a href="{{ route('admin.document-application.index') }}"
                        ...
                        @if($pendingDocs > 0)
                            <span
                                class="ml-auto px-2.5 py-1 text-[10px] font-bold bg-gradient-to-r from-amber-400 to-orange-500 text-white rounded-full shadow-lg">{{ $pendingDocs }}</span>
                        @endif
                    </a>
                    ...
                    <a href="{{ route('admin.report.index') }}"
                        ...
                        @if($pendingReports > 0)
                            <span
                                class="ml-auto px-2.5 py-1 text-[10px] font-bold bg-gradient-to-r from-red-400 to-red-600 text-white rounded-full shadow-lg">{{ $pendingReports }}</span>
                        @endif
                    </a>
                ...
                @if(Auth::user()->role === 'student')
                    ...
                    <a href="{{ route('students.warnings.index') }}"
                        ...
                        @if($unreadWarnings > 0)
                            <span
                                class="ml-auto px-2.5 py-1 text-[10px] font-bold bg-gradient-to-r from-amber-400 to-orange-500 text-white rounded-full shadow-lg">{{ $unreadWarnings }}</span>
                        @endif
                    </a>
                    ...
                    <x-sidebar-dropdown :title="__('smart Advisor')" :active="request()->is('students/ai-advisor*')">
                        <x-slot name="icon">
                            <svg class="w-[18px] h-[18px] flex-shrink-0 text-purple-500" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75"
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4"
                style="background: linear-gradient(to top, var(--bg-sidebar) 0%, transparent 100%);">
                <div
                    class="flex items-center gap-3 user-section bg-gradient-to-r from-primary-primary/10 to-primary-dark/10 rounded-2xl p-3 backdrop-blur-sm">
                    <div
        ...
        <div class="flex-1 transition-all duration-300 min-w-0">
            <!-- Top Header -->
            <header
                class="h-20 flex items-center justify-between px-6 md:px-10 sticky top-0 z-20 backdrop-blur-xl bg-white/80 dark:bg-gray-900/80"
                ...
                <div class="flex items-center gap-4">
                    ...
                    @isset($header)
                        <h1
                            class="text-xl font-bold truncate max-w-[200px] md:max-w-none bg-gradient-to-r from-primary-primary to-primary-dark bg-clip-text text-transparent">
                            {{ $header }}</h1>
                    @endisset
                </div>
                    ...
                    <div x-data="{ notifOpen: false }" class="relative">
                        ...
                        <div x-cloak x-show="notifOpen" @click.away="notifOpen = false" x-transition
                            ...
                            <div class="px-4 py-3 flex items-center justify-between"
                                ...
                                <h3 class="font-semibold" style="color: var(--text-primary);">{{ __('Notifications') }}
                                </h3>
                                @if($unreadCount > 0)
                            ...
                            <div class="max-h-80 overflow-y-auto">
                                ...
                                @forelse($notifications as $notif)
                                    ...
                                    <a href="{{ route('notifications.index') }}"
                                        class="block px-4 py-3 hover:bg-primary-light/30 transition {{ !$isRead ? 'bg-indigo-50/50 dark:bg-indigo-950/60' : '' }}"
                                        style="border-bottom: 1px solid var(--border-color);">
                            ...
                            <div class="relative flex-1 px-4 sm:px-6">
                                <div class="grid grid-cols-3 gap-4">
                                    <a href="{{ url('students/study-plan') }}"
                                        ...
                                        <span
                                            class="text-xs text-center font-medium text-gray-700 dark:text-gray-300">{{ __('Fill Study Plan') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('students/transcript') }}"
                                        ...
                                        <span
                                            class="text-xs text-center font-medium text-gray-700 dark:text-gray-300">{{ __('Academic Transcript') }}</span>
                                    </a>
                                    ...
                                    <a href="{{ url('students/graduation-checker') }}"
                                        ...
                                        <span
                                            class="text-xs text-center font-medium text-gray-700 dark:text-gray-300">{{ __('Graduation Checker') }}</span>
                                    </a>
