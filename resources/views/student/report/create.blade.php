    ...
    <div class="max-w-2xl mx-auto">
        <div class="card-saas dark:bg-gray-800 p-6">
            <form action="{{ route('students.report.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="subject" class="block text-sm font-medium text-siakad-dark dark:text-gray-300 mb-2">{{ __('Subject') }}</label>
                ...
                <div class="mb-6">
                    <label for="message" class="block text-sm font-medium text-siakad-dark dark:text-gray-300 mb-2">{{ __('Report Message') }}</label>
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('students.report.index') }}" class="px-4 py-2 text-sm font-medium text-siakad-secondary dark:text-gray-400 hover:text-siakad-dark dark:hover:text-white transition">
                        {{ __('Cancel') }}
                    </a>
