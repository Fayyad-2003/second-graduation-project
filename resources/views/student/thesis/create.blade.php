<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            <a href="{{ route('students.thesis.index') }}" class="inline-flex items-center gap-2 text-siakad-secondary hover:text-siakad-primary transition text-sm">
        ...
        <div class="card-saas overflow-hidden">
            ...
            <form action="{{ route('students.thesis.store') }}" method="POST" class="p-6 space-y-5">
                @csrf
                <div>
                    <label class="block text-sm font-medium text-siakad-dark mb-2">{{ __('Thesis Title') }} *</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-siakad-dark mb-2">{{ __('Field of Study') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-siakad-dark mb-2">{{ __('Abstract / Summary') }}</label>
                    ...
                    <p class="text-xs text-siakad-secondary mt-1">{{ __('Optional, can be completed later') }}</p>
                </div>
