        ...
        <form action="{{ route('lecturers.grading.store', $class->id) }}" method="POST">
            ...
            <div class="px-8 py-6 bg-primary-50/50 dark:bg-primary-900/20 border-b border-primary-100/50 dark:border-primary-800/50 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-[10px] text-primary-400 font-black uppercase tracking-widest mt-0.5">{{ __('Enter numeric value (0.00 - 100.00)') }}</p>
                </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-primary-50/30 dark:bg-primary-900/10 border-b border-primary-100/30 dark:border-primary-800/30">
                            <th class="py-5 px-8 text-[10px] font-black text-primary-400 uppercase tracking-widest w-16 text-center">#</th>
                            <th class="py-5 px-6 text-[10px] font-black text-primary-400 uppercase tracking-widest w-48">{{ __('Student ID') }}</th>
                            <th class="py-5 px-6 text-[10px] font-black text-primary-400 uppercase tracking-widest">{{ __('Student Name') }}</th>
                            <th class="py-5 px-6 text-[10px] font-black text-primary-400 uppercase tracking-widest text-center w-40">{{ __('Score (0-100)') }}</th>
                    ...
                    <tbody class="divide-y divide-primary-50/50 dark:divide-primary-800/30">
                        ...
                        <tr class="hover:bg-primary-50/20 dark:hover:bg-primary-900/10 transition-colors group">
                            <td class="py-5 px-8 text-xs font-bold text-primary-400 text-center">{{ $index + 1 }}</td>
                            <td class="py-5 px-6">
                                <span class="text-xs font-black text-primary-700 dark:text-primary-300 font-mono tracking-wider">{{ $detail->studyPlan->student->student_number }}</span>
                            </td>
                            <td class="py-5 px-6">
                            ...
                            <td class="py-5 px-6 text-center">
                                <div class="max-w-[120px] mx-auto">
                                    <input type="number"
                                        ...
                                        min="0"
                                        max="100"
                                        class="input-saas text-center font-black text-sm py-2 px-4 focus:ring-4 focus:ring-primary-primary/10"
                                        placeholder="0.00">
                                </div>
                            </td>
