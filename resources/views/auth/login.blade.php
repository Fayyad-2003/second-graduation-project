<x-guest-layout>
    <div class="mb-10">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">{{ __('Welcome Back') }}</h2>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('Please enter your details to sign in.') }}</p>
    </div>
            ...
            <label for="remember_me" class="inline-flex items-center group cursor-pointer">
                <div class="relative flex items-start">
                    ...
                    <div class="ml-2 text-sm">
                        <span class="text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">{{ __('Remember me for 30 days') }}</span>
                    </div>
                </div>
            </label>
