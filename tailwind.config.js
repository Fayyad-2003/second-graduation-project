    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'glow-sm': '0 0 0 1px rgb(14 165 233 / 0.1), 0 0 8px rgb(14 165 233 / 0.15)',
                'glow': '0 0 0 1px rgb(14 165 233 / 0.15), 0 0 16px rgb(14 165 233 / 0.2)',
                'glow-lg': '0 0 0 1px rgb(14 165 233 / 0.2), 0 0 32px rgb(14 165 233 / 0.25)',
                'glow-brand': '0 0 0 1px rgb(99 102 241 / 0.15), 0 0 16px rgb(99 102 241 / 0.2)',
                'glow-success': '0 0 0 1px rgb(34 197 94 / 0.15), 0 0 16px rgb(34 197 94 / 0.2)',
                'glow-warning': '0 0 0 1px rgb(245 158 11 / 0.15), 0 0 16px rgb(245 158 11 / 0.2)',
                'glow-danger': '0 0 0 1px rgb(239 68 68 / 0.15), 0 0 16px rgb(239 68 68 / 0.2)',
            ...
            animation: {
                ...
                'scale-in-spring': 'scaleIn 300ms cubic-bezier(0.34, 1.56, 0.64, 1)',
                // Micro-interactions
            ...
            backgroundImage: {
                ...
                'mesh-gradient-1': 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
                ...
                'mesh-gradient-6': 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)',
                'mesh-gradient-7': 'linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%)',
                'mesh-gradient-8': 'linear-gradient(135deg, #a18cd1 0%, #fbc2eb 100%)',
            },
            backgroundSize: {
                '300%': '300% 300%',
            },
